...
export const countyBounds: Record<string, LngLatBoundsLike> = {
  '34007': [
    [-75.148914417, 39.598393428],
    [-74.726179781, 40.006345891],
  ],
  '34015': [
    [-75.439045829, 39.504883061],
    [-74.867311364, 39.897740303],
  ],
  '34021': [
    [-74.952933694, 40.126772837],
    [-74.471143977, 40.434126635],
  ],
  '34005': [
    [-75.07071901, 39.531209636],
    [-74.379708211, 40.193648533],
  ],
  '42017': [
    [-75.493695855, 40.039041456],
    [-74.711045606, 40.618558937],
  ],
  '42029': [
    [-76.146600079, 39.711425496],
    [-75.350943711, 40.255137484],
  ],
  '42045': [
    [-75.611574526, 39.791629486],
    [-75.201236774, 40.076287706],
  ],
  '42101': [
    [-75.290286082, 39.85680148],
    [-74.945752224, 40.147922319],
  ],
  '42091': [
    [-75.706825576, 39.967006411],
    [-75.004968904, 40.457040632],
  ],
};
...
export const dataTextMap: Partial<Record<HealthPropertyKeys, string[]>> = {
  ...
  casthma: [
    '**%s** of residents in %s currently have asthma.',
  ...
  chd: [
    '**%s** of residents in %s currently have Congenital Heart Disease (CHD).',
  ...
  diabetes: [
    '**%s** of residents in %s have been diagnosed with diabetes.',
  ...
  obesity: [
    '**%s** of residents in %s are affected by obesity.',
    'This tract falls within the **%s** percentile of the region, indicating that more people in %s are considered obese than in %s of tracts in the DVRPC region. ',
  ],
  nocar: [
    '**%s** of residents in %s do not have access to a car.',
    'This tract falls within the **%s percentile** of the region, indicating that more individuals do not have access to a car in %s than in %s of tracts in the DVRPC region.',
  ],
  inactive_comm: [
    '**%s** of residents in %s do not commute via walking, biking, or transit.',
    'This tract falls within the **%s percentile** of the region, indicating that more individuals in %s participate in sedentary commutes than in %s of tracts in the DVRPC region.',
  ],
  unemp: [
    '**%s** of residents in the labor force in %s are unemployed.',
    'This tract falls within the **%s percentile** of the region, indicating that there are more people experiencing unemployment in Census Tract %s than in %s of tracts in the DVRPC region.',
  ],
  nohighschool: [
