...
export type HealthPropertyKeys = 'access2' | 'arthritis' | 'binge' | 'bphigh' | 'bpmed' | 'cancer' | 'casthma' | 'chd' | 'checkup' | 'cholscreen' | 'cognition' | 'colon_screen' | 'copd' | 'csmoking' | 'dental' | 'depression' | 'diabetes' | 'disability' | 'emotionspt' | 'foodinsecu' | 'foodstamp' | 'ghlth' | 'hearing' | 'highchol' | 'housinsecu' | 'inactive_comm' | 'indeplive' | 'isolation' | 'lacktrpt' | 'lpa' | 'mammouse' | 'mhlth' | 'mobility' | 'nocar' | 'nohighschool' | 'obesity' | 'own_burden' | 'phlth' | 'rent_burden' | 'selfcare' | 'shututility' | 'sleep' | 'stroke' | 'teethlost' | 'unemploy' | 'vision';
